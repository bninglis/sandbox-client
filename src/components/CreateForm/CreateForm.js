        ...
        <>
            <form className="create" ref={formRef} onSubmit={handleSubmit}>
                <div className="create__names">
                    <input className="create__field create__field--top create__field--left" type="text" name="firstname" id="firstname" placeholder="First Name" />
                    <input className="create__field create__field--top create__field--left" type="text" name="lastname" id="lastname" placeholder="Last Name" />
                </div>
            ...
            <p>
                Already have and account? <span className="bold">Log in</span>
            </p>
        </>
    );
}
